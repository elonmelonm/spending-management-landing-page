...
const SuccessStorieSection = () => {
    return (
        <section className="w-full h-[890px] p-[120px] items-center relative bg-white flex flex-col">
            <div className="flex flex-col gap-16">
                <div className="flex flex-col w-[634px] h-[162px] justify-center gap-3">
                    <span className="w-full h-[30px] text-primary-500 font-semibold text-[20px]">
                ...
                <div className="flex flex-row gap-[188px]">
                    <div className="flex flex-col gap-12">
                        ...
                        <div className="flex flex-col w-[526px] h-[294px] p-8 text-secondary-700 justify-center rounded-[12px] gap-8">
                    ...
                    <div className="w-[486px] h-[434px] rounded-[12px]">
                        <img src={Success} alt="" />
                    </div>
                </div>
            </div>
