...
const HowItWorksSecondSection = () => {
    return (
        <section className="w-[1440px] h-[890px] relative bg-secondary-700 flex flex-col">
            <div className="w-[712px] h-[186px] absolute top-[120px] left-[120px] rounded-[12px]">
                <img src={Content} alt="" />
            </div>

            <div className="flex flex-col w-[491px] h-[216px] absolute justify-center top-[120px] left-[810px] gap-6">
                <div className="w-[468px] h-[102px] flex flex-col justify-center  gap-3">
            ...
            <div className="flex flex-col w-[526px] h-[288px] p-8 bg-secondary-500 absolute justify-center top-[368px] left-[810px] rounded-[12px] gap-10">
